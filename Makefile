...
define Build/Compile
	f="component-server concurrency-linux-epoll concurrency-posix-threads transfer-linux-splice" OS=OpenWrt ARCH=NA $(MAKE) -C $(PKG_BUILD_DIR) $(TARGET_CONFIGURE_OPTS)
endef
