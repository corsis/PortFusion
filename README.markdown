...
| `user@remote>`<strong><pre>PortFusion             ] 2000        [</pre></strong> `user@local>`<pre>PortFusion 3389 server - 2000 remote [ 3389</pre> | <pre>rem> PortFusion      ]        2000 [</pre> <pre>loc> PortFusion 3128 ] remote 2000 - server 3128</pre>
