...
<span style="font-size: small">(¹ now also available for ARM CPUs and ² as [64-bit-native Windows binary](https://github.com/downloads/corsis/PortFusion/PortFusion64.exe))</span>
