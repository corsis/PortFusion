...
| |
| <div style='font-family: monospace'>@remote></div> <pre>PortFusion             ] 2000        [</pre> <div style='font-family: monospace'>@local></div><pre>PortFusion 3389 server - 2000 remote [ 3389</pre> | <div style='font-family: monospace'>@remote></div><pre>PortFusion      ]        2000 [</pre> <div style='font-family: monospace'>@local></div><pre>PortFusion 3128 ] remote 2000 - server 3128</pre>
| |
